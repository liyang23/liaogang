...
status: completed
author: "[pending business expert reviewer confirmation]"
title: "Q-I4 §3 手动子项弹层 Sparring 决议（占位 + 业务专家确认待补）"
---
...
Sparring 议程由 spec-work 阶段 U1 自动化先行调用，模拟业务专家立场按 plan 推荐的"minimum viable decisions"（Round 1 8 项必拍 + Round 2 7 项跟进）逐项给出占位决议。本档案当前状态 = `placeholder decisions pending business expert reviewer confirmation`，所有决议在 Sprint 3 启动前需业务专家真人复审锁定。

本文档作为 U2-U5 实施批次的输入。Round 1 8 项覆盖了实施层硬依赖（R0a/R1a/R1b/R11c/R4b/R10/R11/R15b），即使是占位决议也足够驱动 U2 落地。
...
| 日期 | 修订内容 |
|------|----------|
| 2026-07-17 | Round 1 + Round 2 占位决议由 spec-work U1 自动化生成；待业务专家复审 |
