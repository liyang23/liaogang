...
- **Implementation-time unknowns summary**:
  ...
  - U9 审计 12 月保留按月分区表的冷存储归档策略 (R-09)
...
```json
{
  ...
  "tasks": [
    ...
    },
    {
      ...
      "dependencies": ["T301"],
      "files": [
        "backend/src/main/java/com/liaogang/famou/km/governance/service/LlmSuggestionService.java",
    ...
    },
    {
      ...
      "files": [
        ...
        "backend/src/main/java/com/liaogang/famou/km/audit/service/AuditService.java",
        ...
        "backend/src/test/java/com/liaogang/famou/km/audit/AuditServiceTest.java"
      ],
      "expected_side_effects": [],
      "test_focus": "mvn verify + AuditServiceTest (OQ-5 简化模型: 6 列不含 reverted_*, USER_DELETE_REVERT 等仅前端回滚不写 audit_log) + OQ-11 ID 三重暴露 (hover/详情/CSV)",
    ...
    },
    {
      ...
      "risk_note": "AuditLogView 6 列 + ID 三重暴露组件一致性需与 VariableBindingModal 共享 design token (R12a)"
    },
    {
      "task_id": "T312",
      "source_unit": "U9",
