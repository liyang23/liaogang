...
- ✅ Q-I4 §3 手动子项弹层 UI 细节（Q-I4）— 已闭环 + 正式生效（2026-07-17，用户授权跳过复审）：业务专家 sparring 议程决议归档 `docs/sparring/2026-07-17-001-q-i4-section3-sparring-decisions.md`（status=ratified）；Round 1 minimum viable 8 项 + Round 2 跟进 5 项 + 5 项 PRD 已锁边界共 13+5=18 项决议正式生效；U2-U5 实施批次 commit 已完成（`docs/plans/2026-07-17-001-feat-liaogang-section3-manual-subitem-modal-plan.md`; commits c04014a + 63606c8）
